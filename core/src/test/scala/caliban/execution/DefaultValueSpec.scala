        ...
        interpreter.flatMap(_.execute(introspectionQuery)).map { response =>
          assertTrue(
            response.data.toString ==
              """{"__schema":{"queryType":{"name":"Query"},"mutationType":null,"subscriptionType":null,"types":[{"kind":"SCALAR","name":"Boolean","fields":null,"inputFields":null},{"kind":"SCALAR","name":"Float","fields":null,"inputFields":null},{"kind":"SCALAR","name":"Int","fields":null,"inputFields":null},{"kind":"OBJECT","name":"Query","fields":[{"name":"testDefault","description":null,"args":[{"name":"intValue","description":null,"defaultValue":"1"}]}],"inputFields":null},{"kind":"SCALAR","name":"String","fields":null,"inputFields":null},{"kind":"OBJECT","name":"__Directive","fields":[{"name":"name","description":null,"args":[]},{"name":"description","description":null,"args":[]},{"name":"locations","description":null,"args":[]},{"name":"args","description":null,"args":[]},{"name":"isRepeatable","description":null,"args":[]}],"inputFields":null},{"kind":"ENUM","name":"__DirectiveLocation","fields":null,"inputFields":null},{"kind":"OBJECT","name":"__EnumValue","fields":[{"name":"name","description":null,"args":[]},{"name":"description","description":null,"args":[]},{"name":"isDeprecated","description":null,"args":[]},{"name":"deprecationReason","description":null,"args":[]}],"inputFields":null},{"kind":"OBJECT","name":"__Field","fields":[{"name":"name","description":null,"args":[]},{"name":"description","description":null,"args":[]},{"name":"args","description":null,"args":[]},{"name":"type","description":null,"args":[]},{"name":"isDeprecated","description":null,"args":[]},{"name":"deprecationReason","description":null,"args":[]}],"inputFields":null},{"kind":"OBJECT","name":"__InputValue","fields":[{"name":"name","description":null,"args":[]},{"name":"description","description":null,"args":[]},{"name":"type","description":null,"args":[]},{"name":"defaultValue","description":null,"args":[]}],"inputFields":null},{"kind":"OBJECT","name":"__Schema","fields":[{"name":"description","description":null,"args":[]},{"name":"queryType","description":null,"args":[]},{"name":"mutationType","description":null,"args":[]},{"name":"subscriptionType","description":null,"args":[]},{"name":"types","description":null,"args":[]},{"name":"directives","description":null,"args":[]}],"inputFields":null},{"kind":"OBJECT","name":"__Type","fields":[{"name":"kind","description":null,"args":[]},{"name":"name","description":null,"args":[]},{"name":"description","description":null,"args":[]},{"name":"fields","description":null,"args":[{"name":"includeDeprecated","description":null,"defaultValue":null}]},{"name":"interfaces","description":null,"args":[]},{"name":"possibleTypes","description":null,"args":[]},{"name":"enumValues","description":null,"args":[{"name":"includeDeprecated","description":null,"defaultValue":null}]},{"name":"inputFields","description":null,"args":[]},{"name":"ofType","description":null,"args":[]},{"name":"specifiedBy","description":null,"args":[]}],"inputFields":null},{"kind":"ENUM","name":"__TypeKind","fields":null,"inputFields":null}]}}"""
          )
        }
      }
    )
