 ...
 */
case class GraphQLResponse[+E](data: ResponseValue, errors: List[E] = Nil, extensions: Option[ObjectValue] = None)
...
object GraphQLResponse {
  ...
  implicit def circeDecoder[F[_]: IsCirceDecoder, E]: F[GraphQLResponse[E]] =
    GraphQLResponseCirce.graphQLResponseDecoder.asInstanceOf[F[GraphQLResponse[E]]]
}
...
private object GraphQLResponseCirce {
  ...
  val graphQLResponseDecoder: Decoder[GraphQLResponse[GraphQLResponseError]] =
    deriveDecoder[GraphQLResponse[GraphQLResponseError]]
