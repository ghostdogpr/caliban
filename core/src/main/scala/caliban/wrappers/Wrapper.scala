...
object Wrapper {
   ...
   */
  trait ValidationWrapper[-R] extends SimpleWrapper[R, ValidationError, ExecutionRequest, ValidationWrapperInput]
  ...
  case class ValidationWrapperInput(document: Document, skipValidation: Boolean)
}
