...
3. **Subgraph errors:** rewrite to client paths and pass safe fields by default, with configurable redaction. Never expose generated `_entities` paths or blindly trust arbitrary extensions.
