...
This ticket deliberately handles one nullable object representation and one entity transition. A null parent skips the lookup, while list-valued joins fail during planning. List batching and correlation remain Ticket 5, cross-source result completion remains Ticket 6, and multi-hop joins remain Ticket 11.
