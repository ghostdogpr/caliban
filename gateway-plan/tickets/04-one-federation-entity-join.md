...
At Ticket 4 completion, the gateway deliberately handled one nullable object representation and one entity transition. A null parent skipped the lookup, while list-valued joins failed during planning. Ticket 5 subsequently added list batching and correlation; cross-source result completion remains Ticket 6, and multi-hop joins remain Ticket 11.
