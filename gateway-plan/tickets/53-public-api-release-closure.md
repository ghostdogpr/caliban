# 53 — Close the public API and release
...
**Blocked by:** 34 — Close compatibility and confirm publication matrix; 42 — Close operational race and interruption testing; 50 — Verify the useful-throughput gate; 51 — Add optional OpenTelemetry integration; 52 — Write examples and migration documentation
...
- [ ] Gateway publication is enabled only for the final confirmed Scala versions after every other acceptance criterion in this ticket passes.
