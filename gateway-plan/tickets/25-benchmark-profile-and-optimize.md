...
**Blocked by:** 23 — Add the encoded response path; 24 — Close the Federation Gateway Audit
...
- [ ] Semantic, audit, lifecycle, and structured-versus-encoded tests remain green after optimization.
