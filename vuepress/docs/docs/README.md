...
```
libraryDependencies += "com.github.ghostdogpr" %% "caliban-http4s" % "0.5.0"    // routes for http4s
libraryDependencies += "com.github.ghostdogpr" %% "caliban-akka-http" % "0.5.0" // routes for akka-http
libraryDependencies += "com.github.ghostdogpr" %% "caliban-cats"   % "0.5.0"    // interop with cats effect
```
