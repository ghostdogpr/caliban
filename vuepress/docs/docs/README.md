...
```scala
"com.github.ghostdogpr" %% "caliban-quick"  % "2.8.0"
```
...
```scala
"com.github.ghostdogpr" %% "caliban-http4s"     % "2.8.0" // routes for http4s
"com.github.ghostdogpr" %% "caliban-akka-http"  % "2.8.0" // routes for akka-http
"com.github.ghostdogpr" %% "caliban-pekko-http" % "2.8.0" // routes for pekko-http
"com.github.ghostdogpr" %% "caliban-play"       % "2.8.0" // routes for play

"com.github.ghostdogpr" %% "caliban-cats"       % "2.8.0" // interop with cats-effect
"com.github.ghostdogpr" %% "caliban-monix"      % "2.8.0" // interop with monix
"com.github.ghostdogpr" %% "caliban-tapir"      % "2.8.0" // interop with tapir

"com.github.ghostdogpr" %% "caliban-federation" % "2.8.0" // apollo federation
"com.github.ghostdogpr" %% "caliban-reporting"  % "2.8.0" // apollo schema reporting
"com.github.ghostdogpr" %% "caliban-tracing"    % "2.8.0" // open-telemetry
```
