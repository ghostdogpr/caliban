...
```
libraryDependencies += "com.github.ghostdogpr" %% "caliban" % "0.7.0"
```

The following modules are optional:

```
libraryDependencies += "com.github.ghostdogpr" %% "caliban-http4s"    % "0.7.0" // routes for http4s
libraryDependencies += "com.github.ghostdogpr" %% "caliban-akka-http" % "0.7.0" // routes for akka-http
libraryDependencies += "com.github.ghostdogpr" %% "caliban-finch"     % "0.7.0" // routes for finch
libraryDependencies += "com.github.ghostdogpr" %% "caliban-cats"      % "0.7.0" // interop with cats effect
libraryDependencies += "com.github.ghostdogpr" %% "caliban-monix"     % "0.7.0" // interop with monix
```
