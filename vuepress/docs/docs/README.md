...
"com.github.ghostdogpr" %% "caliban-zio-http"   % "2.4.2" // routes for zio-http
"com.github.ghostdogpr" %% "caliban-cats"       % "2.4.2" // interop with cats effect
"com.github.ghostdogpr" %% "caliban-monix"      % "2.4.2" // interop with monix
"com.github.ghostdogpr" %% "caliban-tapir"      % "2.4.2" // interop with tapir
"com.github.ghostdogpr" %% "caliban-federation" % "2.4.2" // interop with apollo federation
