...
```scala
"com.github.ghostdogpr" %% "caliban-http4s"     % "2.4.3" // routes for http4s
"com.github.ghostdogpr" %% "caliban-akka-http"  % "2.4.3" // routes for akka-http
"com.github.ghostdogpr" %% "caliban-play"       % "2.4.3" // routes for play
"com.github.ghostdogpr" %% "caliban-zio-http"   % "2.4.3" // routes for zio-http
"com.github.ghostdogpr" %% "caliban-cats"       % "2.4.3" // interop with cats effect
"com.github.ghostdogpr" %% "caliban-monix"      % "2.4.3" // interop with monix
"com.github.ghostdogpr" %% "caliban-tapir"      % "2.4.3" // interop with tapir
"com.github.ghostdogpr" %% "caliban-federation" % "2.4.3" // interop with apollo federation
"com.github.ghostdogpr" %% "caliban-tracing"    % "2.4.3" // interop with zio-telemetry
```
