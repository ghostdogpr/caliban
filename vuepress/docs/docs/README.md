...
```
libraryDependencies += "com.github.ghostdogpr" %% "caliban" % "0.3.0"
```

The following modules are optional:

```
libraryDependencies += "com.github.ghostdogpr" %% "caliban-http4s" % "0.3.0" // routes for http4s
libraryDependencies += "com.github.ghostdogpr" %% "caliban-cats"   % "0.3.0" // interop with cats effect
```
