...
```scala
"com.github.ghostdogpr" %% "caliban" % "3.1.1"
```
...
```scala
"com.github.ghostdogpr" %% "caliban-quick"  % "3.1.1"
```
...
```scala
"com.github.ghostdogpr" %% "caliban-http4s"     % "3.1.1" // routes for http4s
"com.github.ghostdogpr" %% "caliban-akka-http"  % "3.1.1" // routes for akka-http
"com.github.ghostdogpr" %% "caliban-pekko-http" % "3.1.1" // routes for pekko-http
"com.github.ghostdogpr" %% "caliban-play"       % "3.1.1" // routes for play

"com.github.ghostdogpr" %% "caliban-cats"       % "3.1.1" // interop with cats-effect
"com.github.ghostdogpr" %% "caliban-monix"      % "3.1.1" // interop with monix
"com.github.ghostdogpr" %% "caliban-tapir"      % "3.1.1" // interop with tapir

"com.github.ghostdogpr" %% "caliban-federation" % "3.1.1" // apollo federation
"com.github.ghostdogpr" %% "caliban-reporting"  % "3.1.1" // apollo schema reporting
"com.github.ghostdogpr" %% "caliban-tracing"    % "3.1.1" // open-telemetry
"com.github.ghostdogpr" %% "caliban-stitching"  % "3.1.1" // stitching
```
