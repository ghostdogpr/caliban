...
```scala
calibanGenSchema schemaPath outputPath [--scalafmtPath path] [--headers name:value,name2:value2] [--packageName name] [--effect fqdn.Effect]  [--typeMappings gqlType:f.q.d.n.Type,gqlType2:f.q.d.n.Type2]
