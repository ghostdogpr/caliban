...
object CalibanClientError {
   ...
   */
  final case class DecodingError(msg: String, innerThrowable: Option[Throwable] = None) extends CalibanClientError {
   ...
   */
  final case class ServerError(errors: List[GraphQLResponseError]) extends CalibanClientError {
