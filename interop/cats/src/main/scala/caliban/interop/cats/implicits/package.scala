...
package object implicits {
  ...
  implicit class CatsEffectGraphQLInterpreter[R, E](private val underlying: GraphQLInterpreter[R, E]) extends AnyVal {
    ...
    def checkAsync[F[_]](query: String)(implicit interop: ToEffect[F, Any], runtime: Runtime[Any]): F[Unit] =
  ...
  implicit class CatsEffectGraphQL[R](private val underlying: GraphQL[R]) extends AnyVal {
    def interpreterAsync[F[_]](implicit
      interop: ToEffect[F, Any],
      runtime: Runtime[Any]
    ): F[GraphQLInterpreter[R, CalibanError]] =
